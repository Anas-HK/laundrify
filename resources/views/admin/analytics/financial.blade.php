...
<div class="container-fluid">
    ...
    <div class="date-filter mb-4">
        <form action="{{ route('admin.analytics.financial') }}" method="GET" class="row g-3 align-items-center">
            <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="metric-card">
                <div class="metric-value">{{ number_format($analytics['totalRevenue']) }} PKR</div>
                <div class="metric-label">Total Revenue</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="metric-card">
                <div class="metric-value">{{ number_format($analytics['totalOrders']) }}</div>
                <div class="metric-label">Total Orders</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="metric-card">
                <div class="metric-value">{{ number_format($analytics['avgOrderValue'], 2) }} PKR</div>
            ...
            <div class="card analytics-card">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold text-success">
                        <i class="fas fa-chart-bar"></i> Daily Orders
                    </h6>
                </div>
                <div class="card-body">
                    <div class="chart-container">
            ...
            <div class="card analytics-card">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold text-warning">
                        <i class="fas fa-trophy"></i> Top Revenue Services
                    </h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered data-table">
                            ...
                            <tbody>
                                @foreach($analytics['topServices'] as $service)
                                <tr>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Daily Revenue Chart
        const revenueData = {
            labels: {!! json_encode(array_keys($analytics['revenueByDay'])) !!},
            datasets: [{
                label: 'Revenue (PKR)',
                data: {!! json_encode(array_values($analytics['revenueByDay'])) !!},
        ...
        // Daily Orders Chart
        const ordersData = {
            labels: {!! json_encode(array_keys($analytics['ordersByDay'])) !!},
            datasets: [{
                label: 'Orders',
                data: {!! json_encode(array_values($analytics['ordersByDay'])) !!},
        ...
        const categoryLabels = Object.keys({!! json_encode($analytics['revenueByCategory']) !!});
        const categoryData = Object.values({!! json_encode($analytics['revenueByCategory']) !!});
